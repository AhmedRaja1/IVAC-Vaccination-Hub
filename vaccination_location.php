...
$locations_list = $db->getLocationsList();
...
if (isset($_POST['add_location_btn'])) {
  ...
  $flag = $db->add_location($name, $shortname);
...
<input type="hidden" name="id_catch" value="<?php echo $u['id']; ?>"/>
...
<input type="hidden" name="id_loc" value="<?php echo $u['id']; ?>"/>
